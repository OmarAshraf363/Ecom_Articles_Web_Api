...
{
    public record ArticleDTO( int id,string Title, string Description, string BaseImageUrl,string UserId,string UserName, DateTime CreatedAt,int Likes,int Comments, List<ArticleRowDTO>? ArticleRows,string? userImage);
